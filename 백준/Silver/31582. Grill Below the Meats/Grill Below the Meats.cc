...
void solve(ll testcase){
    vector<vector<char>> M(40, vector<char>(40, '.'));
    for (ll i=0; i<10; i++) M[i][0] = '1';
    for (ll i=0; i<40; i++) M[9][i] = '1';
    for (ll i=9; i<19; i++) M[i][39] = '1';
    for (ll i=10; i<20; i++) M[i][0] = '2';
    for (ll i=0; i<40; i++) M[19][i] = '2';
    for (ll i=19; i<29; i++) M[i][39] = '2';
    for (ll i=20; i<30; i++) M[i][0] = '3';
    for (ll i=0; i<40; i++) M[29][i] = '3';
    for (ll i=29; i<39; i++) M[i][39] = '3';
    for (auto& e: M) {
        for (auto& v: e)
            io << v;
        io << '\n';
